...
/**
 * 1.使用 WebView 来加载登录网址，实现登录账户的填写及登录
 * 2.是否同意授权，如果同意授权，重定向另一个URL，会有一个临时授权码 code
 * 3.拿到临时授权码之后，使用 API 来获得用户 Token
 * 4.获得用户 Token 之后，访问 user,public_repo,repo，主要为了拿到用户信息展示出来
 */
public class LoginActivity extends AppCompatActivity implements LoginView {
    ...
    private void initWebView() {
        ...
        // 设置 WdebView 进度的监听，让他加载完成之后，隐藏动画，显示 WebView
