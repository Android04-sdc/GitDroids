 ...
 * <p/>
 * <p/>
 * 此类包含与 Activity 相关的一些常用方法，例如 startActivity 和 showToast。
 * 我使用这个类做为 BaseActivity 的替代方案，以避免过深的继承树引入的复杂性。
 * 有点类似于一种不太标准的委托模式。
 */
@SuppressWarnings("unused")
public class ActivityUtils {

    // 使用弱引用，避免不恰当地持有 Activity 或 Fragment 的引用。
    // 持有 Activity 的引用会阻止 Activity 的内存回收，增大 OOM 的风险。
     ...
     * <p/>
     * <p/>
     * 通过弱引用获取 Activity 对象，此方法可能返回 null，调用后需要做检查。
     *
